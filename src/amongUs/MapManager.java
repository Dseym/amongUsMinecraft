...
import tasks.Task;
import tasks.list.CalibrateDistr;
import tasks.list.Card;
import tasks.list.ClearOxygen;
import tasks.list.Energy;
import tasks.list.Meteor;
import tasks.list.Rabbish;
import tasks.list.Reactor;
import tasks.list.Refuel;
...
import tasks.list.Scan;
import tasks.list.Shield;
import tasks.list.ShipWay;
import tasks.list.StabilizeDrive;
import tasks.list.StabilizeWay;
import tasks.list.UnlockManifold;
import tasks.list.Upload_Download;
import tasks.list.Wiring;
